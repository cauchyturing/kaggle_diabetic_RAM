...
layers = [
    ...
    (Conv2DLayer, conv_params(2 * n, filter_size=(5, 5), stride=(1, 1), pad=1, partial_sum=1)),
    (Conv2DLayer, conv_params(2 * n, partial_sum=1)),
    (Conv2DLayer, conv_params(2 * n, partial_sum=1)),
    (MaxPool2DLayer, pool_params(stride=(2,2))),
    (Conv2DLayer, conv_params(4 * n, partial_sum=1)),
    (Conv2DLayer, conv_params(4 * n, partial_sum=1)),
    (Conv2DLayer, conv_params(4 * n, partial_sum=1)),
    #(MaxPool2DLayer, pool_params(stride=(2,2))),
    (Conv2DLayer, conv_params(8 * n, partial_sum=1)),
    (Conv2DLayer, conv_params(8 * n, partial_sum=1)),
    (Conv2DLayer, conv_params(8 * n, partial_sum=1)),
    #(MaxPool2DLayer, pool_params(stride=(2,2))),
    (Conv2DLayer, conv_params(16 * n, partial_sum=9)),
    (Conv2DLayer, conv_params(16 * n, partial_sum=9)),
